...
const POSITIVE_EMOTIONS = ['calm', 'hopeful', 'warm', 'safe', 'brave', 'determined', 'strong', 'loved', 'alive', 'peace', 'relief', 'smile', 'laugh', 'relaxed', 'soothe', 'comfort', 'grinned', 'eased', 'steady', 'free'];
const NEGATIVE_EMOTIONS = ['angry', 'furious', 'terrified', 'broken', 'cold', 'numb', 'lost', 'alone', 'despair', 'panic', 'shame', 'fear', 'dread', 'horror', 'pain', 'cruel', 'harsh', 'shaking', 'tremble', 'clench', 'fists', 'tears', 'cried', 'sob', 'flinch', 'shrank', 'froze', 'nausea', 'bile'];
const PUSHPULL_EMOTIONS = ['confused', 'torn', 'uncertain', 'aching', 'restless', 'tempted', 'drawn', 'guilty', 'wild', 'burn', 'crave', 'yearn', 'trapped', 'hesitate', 'heavy', 'edge', 'flush', 'swallow', 'stare', 'gaze', 'pulse'];
